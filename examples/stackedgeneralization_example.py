...
def generate_model_comparison_chart(base_outputs, meta_output, output_dir):
    ...
    # Word count chart
    bars1 = ax1.bar(model_ids, word_counts, color=colors)
    ...
    bars2 = ax2.bar(model_ids, sentence_counts, color=colors)
...
async def main():
    ...
    config_path = config_dir / "stacking_config.yaml"
    ...
    try:
        ...
        async with Ensemble(**ensemble_kwargs) as ensemble:
            ...
            # Save trace to file
            trace_path = output_dir / "stacking_trace.json"
