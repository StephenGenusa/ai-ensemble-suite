                ...
                try:
                    ...
                    for input_task in input_from_list:
                        if input_task in workflow_context["steps"]:
                            # This is the key fix - make task outputs available as direct variables
                            # This ensures {research} and {analyze} get populated
                    ...
                    step_prompt = self.format_prompt(template_name, **prompt_vars)
