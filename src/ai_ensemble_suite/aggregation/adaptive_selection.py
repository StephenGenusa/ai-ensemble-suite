...
Respond with ONLY the strategy name (e.g., 'confidence_based', 'ensemble_fusion')."""
                      ...
                      selector_prompt = ""
                      try:
                           prompt_vars = {"query": query, "strategy_options": strategy_options_prompt}
                           selector_prompt = self._config_manager.format_prompt(selector_prompt_template, **prompt_vars)
